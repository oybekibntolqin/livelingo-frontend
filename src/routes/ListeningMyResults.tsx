// Listening — "Mening natijalarim" (My Results).
//
// Sodda ro'yxat — barcha materiallar bo'yicha o'tgan urinishlar,
// yangi birinchi.  Har bir urinish uchun: material nomi, Easy/Hard
// belgisi (bo'lsa), ball, sana.  Bosilsa — to'liq natija ekraniga
// (mavjud ListeningResults sahifasiga) o'tkazadi.
//
// ATAYLAB minimal — grafik/diagramma yo'q, chunki bular uchun
// alohida Analytics sahifasi rejalashtirilgan (keyinroq).
...
import { formatTime, type ListeningSubmission } from '../lib/listening'

export default function ListeningMyResults() {
...
function SubmissionRow({ submission: s }: { submission: ListeningSubmission }) {
  ...
  return (
    <Link
      to={`/learn/listening/results/${s.id}`}
